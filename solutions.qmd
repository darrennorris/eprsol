...
Com base nas informações que já conhecemos, existem diferentes opções para saber a extensão em número de pixels desse recorte `buffer.forest1.1km`. Sem R, podemos estimar assim: i) o raio foi de 1 km; ii) assim sendo, a extensão seria o diametro da buffer (raio x 2 = 2km); iii) sabemos que o comprimento de cada pixel é cerca de 29,9 metros, portanto a extensão em número de pixels seria aproximadamente: 2000 metros / 29,9 metros = 66,89 pixels.
...
# Unidades diferentes (raio = metros, área em hectares). 
