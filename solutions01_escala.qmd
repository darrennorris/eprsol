...
-   
    ...
    ii) Sabemos que o resolução (comprimento) de cada pixel é cerca de 29,9 metros. Portanto, a extensão em número de pixels seria aproximadamente: 2000 metros / 29,9 metros = 66,89 pixels.
...
3.  Unidades diferentes (raio = metros, área em hectares), portanto calcular área do buffer em hectares. 785000 / 10000 = 78,5 hectares.
...
Podemos responder usando R em 2 passos assim:
